...
engine.setProperty('rate', rate-30)  # reduce speed by 50 units
...
def wish_user():
    ...
    fun_talk("Wahe guru ji da khalsa , wahe guru ji di fateh . Mein haa FRIDAY.  Tuhadi sevika , How may i assist ju?")
...
def get_command():
    ...
    with sr.Microphone() as source:
        ...
        try:
            ...
            # print(e)
            fun_talk("Say that again please...")
...
if __name__ == '__main__':
    ...
    while True:
        ...
        if 'wikipedia' in query:
        ...
        elif 'open ptu login' in query:
            webbrowser.open("ptuexam.com/")
            ...
            os.startfile("D:\Microsoft VS Code\Visual Studio Code.lnk")

        #elif 'open eclipse' in query:
        #    os.startfile("C:\\Users\\girdh\\OneDrive\\Desktop\\Eclipse IDE for Java Developers - 2023-03.lnk")
        ...
        #                 "Programs\\CodeBlocks\\CodeBlocks")
            ...
            os.startfile("C:\\Users\\Public\Desktop\\VLC media player.lnk")

        elif 'who are you' in query:
            fun_talk("I am Female Replacement Intelligent Digital Assistant Youth or Friday, created by Eshandeep, Gagandeep, "
                     "Girdhar and Grahil as a project in their college. I can do a host of things , Your wish is my command. Please say the word.")
            ...
            fun_talk("He was my classmate,  intelligent guy. We both are best friends.")
            ...
            email_list = {
                'Girdhar': 'girdharking29@gmail.com',
                'Eshan': 'grewaleshandeep.01@gmail.com',
            ...
            try:
                ...
                pass
                 ...
                 fun_talk('okay ji , Tata , Bye bye , Thank You , have a nice day')
                 break
        
else:
    fun_talk('Im sorry , i didnt understand that')    
